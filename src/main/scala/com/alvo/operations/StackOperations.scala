...
object StackOperations {
  ...
  def branch[A: Monoid](termList1: TermList, termList2: TermList)
                       (branch1: ProgramF[A])(branch2: ProgramF[A])
                       (implicit context: TermList => Program[A]): ProgramF[A] =
  ...
  def rep[A: Monoid](termList: TermList)(body: ProgramF[A])(implicit context: TermList => Program[A]): ProgramF[A] =
  ...
  def loop[A: Monoid](testTerm: TermList, bodyTerm: TermList)
                     (test: ProgramF[A])
                     (body: ProgramF[A])
                     (implicit context: TermList => Program[A]): ProgramF[A] =
